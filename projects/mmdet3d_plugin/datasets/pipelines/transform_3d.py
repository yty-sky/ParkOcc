...
class CustomCollect3D(object):
    ...
    def __init__(self,
                 keys,
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img', 'poses',
                            'depth2img', 'cam2img', 'pad_shape', 'cam_intrinsic', 'cam_extrinsic',
                            'build_octree', 'build_octree_up', 'scale_factor', 'flip', 'pcd_horizontal_flip',
                            'pcd_vertical_flip', 'box_mode_3d', 'box_type_3d', 'data_id',
                            'img_norm_cfg', 'pcd_trans', 'sample_idx', 'prev_idx', 'next_idx',
                            'pcd_scale_factor', 'pcd_rotation', 'pts_filename', 'output_origin',
                            'transformation_3d_flow', 'scene_token', 'scene_id', 'frame_id',
